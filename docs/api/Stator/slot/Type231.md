...
<p class="ems">![main window](./img/SlotW231_wind_ext_stator.png)</p>

The `Slot231Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot231` module.
