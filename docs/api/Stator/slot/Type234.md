...
<p class="ems">![main window](./img/SlotW234_wind_ext_stator_constant_tooth.png)</p>

The `Slot234Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot234` module.
...
- **H1_unit**: `Literal["deg", "rad"]` The unit of the `H1`. Default is `"m"`.
