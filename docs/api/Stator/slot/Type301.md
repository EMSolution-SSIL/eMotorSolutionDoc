...
<p class="ems">![main window](./img/SlotW30_wind_ext_stator.png)</p>

The `Slot301Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot301` module.
