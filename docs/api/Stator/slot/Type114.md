...
<p class="ems">![main window](./img/SlotW114_wind_ext_stator_constant_tooth.png)</p>

The `Slot114Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot114` module.
