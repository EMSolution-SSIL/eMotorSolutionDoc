...
<p class="ems">![main window](./img/SlotW233_wind_ext_stator_constant_tooth.png)</p>

The `Slot233Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot233` module.
