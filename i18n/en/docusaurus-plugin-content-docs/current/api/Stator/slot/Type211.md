...
<p class="ems">![main window](./img/SlotW211_wind_ext_stator.png)</p>

The `Slot211Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot211` module.
