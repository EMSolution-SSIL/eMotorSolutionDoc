...
<p class="ems">![main window](./img/SlotW112_wind_ext_stator.png)</p>

The `Slot112Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot112` module.
