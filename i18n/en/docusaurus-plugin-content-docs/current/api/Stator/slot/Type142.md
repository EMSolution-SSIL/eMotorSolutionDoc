...
<p class="ems">![main window](./img/SlotW142_wind_ext_stator.png)</p>

The `Slot142Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot142` module.
