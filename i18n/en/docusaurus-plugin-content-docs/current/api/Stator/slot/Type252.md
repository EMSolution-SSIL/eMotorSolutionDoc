...
<p class="ems">![main window](./img/SlotW252_wind_ext_stator.png)</p>

The `Slot251Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot252` module.
