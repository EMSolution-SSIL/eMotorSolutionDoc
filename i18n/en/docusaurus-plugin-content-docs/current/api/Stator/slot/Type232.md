...
<p class="ems">![main window](./img/SlotW232_wind_ext_stator.png)</p>

The `Slot232Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot232` module.
