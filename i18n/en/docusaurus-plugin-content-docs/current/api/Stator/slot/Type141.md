...
<p class="ems">![main window](./img/SlotW141_wind_ext_stator.png)</p>

The `Slot141Data` is accessed through the `eMotorSolution.CheckPoints.Stator.slots.slot141` module.
