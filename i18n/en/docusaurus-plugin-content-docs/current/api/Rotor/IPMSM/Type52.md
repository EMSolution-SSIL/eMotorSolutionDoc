...
<p class="ems">![main window](../img/HoleM52_mag_int_rotor.png)</p>

The `IPM_HoleMagnet52Data` is accessed through the `eMotorSolution.CheckPoints.Rotor.IPMSM.IPM_HoleMagnet52` module. 
