...
<p class="ems">![main window](../img/SynRM_HoleM61.png)</p>

The `IPM_HoleMagnet61Data` is accessed through the `eMotorSolution.CheckPoints.Rotor.SynRM.SYN_HoleM61` module.
