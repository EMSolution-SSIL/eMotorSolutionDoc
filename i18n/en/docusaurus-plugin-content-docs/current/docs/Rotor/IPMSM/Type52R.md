...
<p class="ems">![main window](../img/HoleM52R_mag_int_rotor.png)</p>

The `IPM_HoleMagnet52RData` is accessed through the `eMotorSolution.CheckPoints.Rotor.IPMSM.IPM_HoleMagnet52R` module.
