---
sidebar_position: 1
title: "Rectangular Magnet with Polar Top"
---
# Rectangular Magnet with Polar Top

<p class="ems">![main window](../img/SPM_SlotM12_external.png)</p>
<p class="ems">![main window](../img/SPM_SlotM12_internal.png)</p>

The **Rectangular Magnet with Polar Top** data class, `SPM_SlotM12Data`, is accessed through the `eMotorSolution.CheckPoints.Rotor.SPMSM.SPM_SlotM12Data` module. 
